...
id_makkiyah_dan_madaniyah = []
for term in makkiyah_dan_madaniyah:
    best_similarity = 0
    best_index = -1
    ...
    # Add matched index
    if best_index != -1:
        id_makkiyah_dan_madaniyah.append(best_index)

print(id_makkiyah_dan_madaniyah)
print(len(id_makkiyah_dan_madaniyah))
print(len(makkiyah_dan_madaniyah))