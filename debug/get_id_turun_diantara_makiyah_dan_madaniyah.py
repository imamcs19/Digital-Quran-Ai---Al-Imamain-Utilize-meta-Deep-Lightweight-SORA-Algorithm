...
id_turun_diantara_makiyah_dan_madaniyah = []
for term in turun_diantara_makiyah_dan_madaniyah:
    best_similarity = 0
    best_index = -1
    ...
    # Add matched index
    if best_index != -1:
        id_turun_diantara_makiyah_dan_madaniyah.append(best_index)

print(id_turun_diantara_makiyah_dan_madaniyah)
print(len(id_turun_diantara_makiyah_dan_madaniyah))
print(len(turun_diantara_makiyah_dan_madaniyah))