...
# {input_no_surah}_{surah_name_latin_alias[input_no_surah-1]}
srt_files = {
    'arabic': f'dataset/srt_raw/{input_no_surah}_{surah_name_latin_alias[input_no_surah-1]}_arabic.srt',
    'indonesian': f'dataset/srt_raw/{input_no_surah}_{surah_name_latin_alias[input_no_surah-1]}_indonesia.srt',
    'javanese': f'dataset/srt_raw/surah_{file_name}_javanese.srt',
    'english': f'dataset/srt_raw/{input_no_surah}_{surah_name_latin_alias[input_no_surah-1]}_english.srt'
}
...
time_intervals = [11, 19.25, 25.27, 33.25]  # Durasi dalam detik

# Contoh penggunaan
file_path = "dataset/Alquran + Terjemahan/112AlIkhlash.mp3"
file_path_save_srt_file = f"dataset/srt/{input_no_surah}_{surah_name_latin_alias[input_no_surah-1]}_combined.srt"
